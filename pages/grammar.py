...
from pages.data.umap_background import (
    plot_cache,
    create_plot_cache_key,
    get_cached_umap_plot,
    GrammarItemsCols,
    GrammarItemsColsPairs,
    grammarMeta,
    Informants,
    item_presets,
    labels_dict,
    normalize_tree_selection,
    compute_umap_background,
)
...
# (GrammarItemsCols, GrammarItemsColsPairs, grammarMeta, Informants are imported
# from pages.data.umap_background above)
...
# presets
# item_presets and labels_dict are imported from pages.data.umap_background above
                    ...
                    dmc.Stack(gap='md',children=[
                        ...
                        dmc.Select(
                            ...
                            data=[
                                ...
                                {"value": "mean_center", "label": "Mean center (subject-wise)"},
                                {"value": "mean_center_col", "label": "Mean center (item-wise)"},
                                {"value": "residuals", "label": "Double mean center (item-wise + subject-wise)"},
                                {"value": "zscore", "label": "Z-score (subject-wise)"},
                                {"value": "zscore_col", "label": "Z-score (item-wise)"},
                                {"value": "l2", "label": "L2-normalization (subject-wise)"},
                                {"value": "mean_l2", "label": "Mean center + L2-normalization (subject-wise)"},
                            ],
                            value="none",
                            size="xs",
                            allowDeselect=False,
...
# normalize_tree_selection is imported from pages.data.umap_background above
...
# Callback 3 (background UMAP computation) is defined in
# pages/data/umap_background.py and imported above so it registers here.
