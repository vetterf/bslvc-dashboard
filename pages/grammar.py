                    ...
                    dmc.Stack(gap='md',children=[
                        ...
                        dmc.Select(
                            ...
                            data=[
                                ...
                                {"value": "mean_center", "label": "Mean center rows (participant-wise)"},
                                {"value": "mean_center_col", "label": "Mean center columns (item-wise)"},
                                {"value": "residuals", "label": "Residuals (item + subject effects)"},
                                {"value": "zscore", "label": "Z-score (row / participant-wise)"},
                                {"value": "zscore_col", "label": "Z-score (column / item-wise)"},
                                {"value": "l2", "label": "L2-normalization (row-wise)"},
                                {"value": "mean_l2", "label": "Mean center rows + L2-normalization"},
                            ],
                            value="none",
                            size="xs",
                            allowDeselect=False,
